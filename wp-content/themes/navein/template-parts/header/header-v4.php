...
<div id="dtr-header-global" class="clearfix">
    <div class="container">
        <div class="dtr-header-global-content">
            ...
            <?php } ?>
            <?php if (is_active_sidebar('widget-header-one') && true == navein_get_theme_option('navein_header_widget_area_one_enable', true) || true == navein_get_theme_option('navein_header_search_enable', false) || true == navein_get_theme_option('navein_header_button_enable', false)) { ?>
