        ...
        <div id="dtr-topbar" class="clearfix">
            <div class="container">
                <div class="dtr-topbar-content">
                    ...
                    <?php } ?>
                    <?php if (true == navein_get_theme_option('navein_header_button_enable', false) || is_active_sidebar('widget-header-three') && true == navein_get_theme_option('navein_header_widget_area_three_enable', true)) { ?>
